...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ɪꜰ yᴏᴜ ɴᴇᴇᴅ ᴍᴏᴠɪᴇ ᴊᴏɪɴ @kkmoviesgroup ᴀɴᴅ ᴀꜱᴋ !</b>")
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                mh = await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[                          
                          InlineKeyboardButton("⚜️ᴋᴋ ʟɪɴᴋꜱ⚜️", url='https://t.me/KanimangalamKovilakam')
                        ]]
                    )
                )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ ᴄᴀɴ'ᴛ ᴀᴄᴄᴇss ❓ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ⚠️", url="https://t.me/+s3bm3EDJiYdhMjE1")
                        ]
                    ]
                )
            )                    
     ...
     #Any Ertors In Thos Code Contact @Master_broi
       ...
       await query.answer()
        ...
        buttons = [[
            InlineKeyboardButton('🪄ᴀʟʟ ᴏᴜʀ ʟɪɴᴋꜱ🪄', url="t.me/KanimangalamKovilakam")
       ],[
            InlineKeyboardButton('🎬ɢʀᴏᴜᴘ🎬', url="t.me/kkmoviesgroup"),
            InlineKeyboardButton('🏅ᴄʜᴀɴɴᴇʟ🏅', url="t.me/KOMOFFICIAL")
       ],[
            InlineKeyboardButton('📣ʙᴏᴛ ᴜᴩᴅᴀᴛᴇꜱ📣', url="t.me/kkfilims"),
            InlineKeyboardButton('🤖ꜱᴜᴘᴘᴏʀᴛ🤖', url="https://t.me/KK_KanimangalamKovilakam")
       ],[
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⌫ ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("☎️Cᴏɴᴛᴀᴄᴛ☎️", url="t.me/KK_KanimangalamKovilakam")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
